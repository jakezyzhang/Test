...
<%@page import="com.zzy.entity.User"%>
<%@page import="com.zzy.dao.impl.UserDaoImpl"%>
...
<html>
 ...
 <div id="header">
			...
			<a href="collectlist2" style="  color: #FFFFFF; text-decoration:none;font-size:15px;position: absolute;left: 1150px">新建</a>
			<div id="banner">
				Web开发工具介绍
			</div>
			 <div id="div1">
